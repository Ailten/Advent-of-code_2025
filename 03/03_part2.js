...
// now, you can turn ON 12 bateries by bank (instead of 2).
...
(async () => {
    ...
    banks.forEach(bank => {
        ...
        for(let iTurnOn=0; iTurnOn<amountBateryCanTurnOn; iTurnOn++){
            ...
            for(let valSearched=9; valSearched>=1; valSearched--){
        ...
        if(arrayOfElementsTurnOn.length !== amountBateryCanTurnOn){
            throw error('!!! to short !!!');
        }
